...
public class MainWindow {
    ...
    public void show() {
        ...
        // Add 'mainBox' to the window. This is a container for holding the other bits:
        // the toolbar,
        ...
        // Set up nextBtnHandler() to be called when nextBtn is clicked, and similarly
        // for prevBtn.
        // ('abc::xyz' is a method reference, essentially a tiny object that calls the
        // specified
        // method.)
    ...
    private void prevBtnHandler(ActionEvent event) {
        // FIXME: fix this code so that it actually displays the previous image &
        // caption.
        album.prev();
        String url = new File(album.getRecord().getFilename()).toURI().toString();
        imageWidget.setImage(new Image(url));
