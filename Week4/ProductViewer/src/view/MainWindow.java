...
public class MainWindow {
    ...
    private void updateGroups() {
        ...
        for (ProductComponent group : catalogue.getProductGroupSet(currentGroup)) {
            newItems.add(group.getName());
        }

        System.out.println("updateGroups1: " + currentGroup);
        ...
        System.out.println("updateGroups2: " + currentGroup);
    }
    ...
    private void updateProducts() {
        ...
        // System.out.println("updateProducts: " + currentGroup);
        ProductComponent group = catalogue.getProductGroup(currentGroup);

        if (group != null) {
            // TODO: getProducts() returns the products in one group. However,
            // we want the to include products in its *sub-groups* as well.

            productTable.getItems().setAll(group.getProducts(new TreeSet<Product>()));
        } else {
